                        ...
                        case 233:
                            {
                                ...
                                //status
                                PGN_230[10] = unchecked((byte)((int)(guidanceStatus)));


                                PGN_230[11] = (byte)11;
                                PGN_230[12] = 12;  //(uint8_t)pwmDisplay;

                                //checksum
                                int CK_A = 0;
                                for (int i = 2; i < PGN_230_Size; i++)
                                    CK_A = (CK_A + PGN_230[i]);

                                PGN_230[PGN_230_Size] = unchecked((byte)((int)(CK_A)));

                                SendUDPMessage(PGN_230);
                        ...
                        case 201:
                            {
                                ...
                                if (data[4] == 5 && data[5] == 201 && data[6] == 201)
                                {
                                    ...
                                    YesMessageBox("ModSimTool will Restart to Enable UDP Networking Changes");
