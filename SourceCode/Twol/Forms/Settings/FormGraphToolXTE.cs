...
namespace Twol
{
    public partial class FormGraphToolXTE : Form
    {
        ...
        public FormGraphToolXTE(Form callingForm)
        {
        ...
        {
            //if (mf.guidanceToolXTE == double.NaN) mf.guidanceToolXTE = 0;
            if (mf.guidanceToolXTE < 1000 || mf.guidanceToolXTE > -1000)
            {

                dataPWM = ((int)(mf.guidanceToolXTE * 100)).ToString(CultureInfo.InvariantCulture);
            }
            else dataPWM = "0";
        ...
        private void FormGraphToolXTE_Load(object sender, EventArgs e)
        {
