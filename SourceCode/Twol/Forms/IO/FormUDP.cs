    ...
    public partial class FormUDP : Form
    {
        ...
        private void FormUDp_Load(object sender, EventArgs e)
        {
            ...
            lblNetworkHelp.Text =
                ...
                Settings.IO.etIP_SubnetThree.ToString();

            nudFirstIP.Value = ipNew[0] = ipCurrent[0] = Settings.IO.etIP_SubnetOne;
            nudSecondIP.Value = ipNew[1] = ipCurrent[1] = Settings.IO.etIP_SubnetTwo;
        ...
        {
            {
                ...
                Settings.IO.etIP_SubnetOne = ipCurrent[0] = ipNew[0];
                Settings.IO.etIP_SubnetTwo = ipCurrent[1] = ipNew[1];
                Settings.IO.etIP_SubnetThree = ipCurrent[2] = ipNew[2];
        ...
        private void nudFirstIP_ValueChanged(object sender, EventArgs e)
        {
            //mf.KeypadToNUD((NumericUpDown)sender, this);
            ipNew[0] = (byte)nudFirstIP.Value;
            ipNew[1] = (byte)nudSecondIP.Value;
        ...
        {
            Settings.IO.setUDP_isOn = false;

            Log.EventWriter("Program Reset: Turning UDP OFF");

            Settings.IO.Save();
            Close();
            mf.YesMessageBox("Restart to Disable UDP Networking Features");
            mf.ExitShutdown();
        }
        ...
        private void btnAutoSet_Click(object sender, EventArgs e)
        {
            ...
            nudSecondIP.Value = mf.scanReply.subnet[1];
