...
namespace Twol
{
    public partial class FormProfiles : Form
    {
        ...
        private void FormCommSaver_Load(object sender, EventArgs e)
        {
            ...
            lblLast.Text = "Using Profile: " + RegistrySettings.IOFileName;
            DirectoryInfo dinfo = new DirectoryInfo(RegistrySettings.IODirectory);
            ...
            lblCurrentProfile.Text = RegistrySettings.IOFileName;

            DirectoryInfo dinfo2 = new DirectoryInfo(RegistrySettings.IODirectory);
        ...
        private void btnSaveNewProfile_Click(object sender, EventArgs e)
        {
            ...
            {
                RegistrySettings.IOFileName = SanitizeFileName(tboxCreateNew.Text.ToString().Trim());
        ...
        private void btnSaveAs_Click(object sender, EventArgs e)
        {
            ...
            {
                RegistrySettings.IOFileName = SanitizeFileName(tboxSaveAs.Text.ToString().Trim());
        ...
        private void cboxChooseExisting_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                RegistrySettings.IOFileName = cboxChooseExisting.SelectedItem.ToString().Trim();
