...
void setup()
{
    ...
    pinMode(4, OUTPUT); //flow valve open      
    pinMode(5, OUTPUT); //flow valve closed

    pinMode(7, OUTPUT);
    pinMode(8, OUTPUT);
    pinMode(9, OUTPUT);
    pinMode(10, OUTPUT); //Relays

    attachInterrupt(0, isr_Flow, FALLING);  //Configures interrupt 0 (pin 2 on the Arduino Uno) to run the isr
